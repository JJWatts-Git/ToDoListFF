...
2. Although the app is compiled, in case you need to change code you will need to rebuild the app. I used npx, which is built into node.js
3. The only language used is node.js in order to use NPM package management. My build uses lates versions, but that should all be built into the app.
4. I built the app in windows, but tested running it on my Mac and had no issues
